...
if (!class_exists('WCZP_front')) {
    ...
    class WCZP_front {
        ...
        function WCZP_before_add_to_cart_btn() {
            ...
            ?>
            <div class="wczpc_maindiv" style="background-color: <?php echo $box_backgrond_clr; ?>;padding: 10px 15px;">
                        ...
                        <?php 
                            if(isset($_COOKIE['wczp_postcode'])) {
                                ...
                                if ($totalrec == 1) {
                                    ...
                                    $available_message2 = str_replace("{state_name}","<strong>".$record[0]->wczp_state."</strong>",$available_message1);
                                    ?>
                                    <div class="pincode_city_and_state"><?php echo $available_message2;?></div>
                                    <?php
                                } else {
                ...
                <div class="wczp_cookie_check_div" style="display: <?php if(isset($_COOKIE['wczp_postcode'])  && $_COOKIE['wczp_postcode'] != "no") { echo "none"; } else { echo "flex"; } ?>;background-color: <?php echo $wczp_check_ibox_bg_clr; ?>;">
                    ...
                    <input type="text" name="wczpcheck" class="wczpcheck" value="<?php if(isset($_COOKIE['wczp_postcode']) && sanitize_text_field($_COOKIE['wczp_postcode']) != "no") { echo sanitize_text_field($_COOKIE['wczp_postcode']); } ?>" style="background-color: <?php echo $wczp_check_ibox_bg_clr; ?>; color: <?php echo $wczp_check_ibox_text_clr; ?>;">
                ...
                <span class="wczp_empty"><?php echo get_option('wczp_pincode_empty_error_message', 'Pincode field should not be empty!') ?></span>
            </div>
            <?php    
        }
        ...
        function WCZP_check_location() {
          ...
          $codtxt = "<p>".$cash_on_delivary_text."</p><span>".$cod_avail."</span>";
            ...
            if($totalrec == 1) {
                ...
                $available_message1 = str_replace("{city_name}","<strong>".$record[0]->wczp_city."</strong>","YES, We Deliver to {city_name}, {state_name}");
                $available_message2 = str_replace("{state_name}","<strong>".$record[0]->wczp_state."</strong>",$available_message1);
                $avai_msg .= '<div class="pincode_city_and_state">'.$available_message2.'</div>';
            }
