                            ...
                            <form method="post">
                                ...
                                <table class="wczp_table">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" name="txtdelivery" min=0 value="<?php echo $record[0]->wczp_ddate; ?>" required="">
                        ...
                        <div class="wczp_container">
                            ...
                            <form method="post">
                                ...
                                <table class="wczp_table">
                                    ...
                                    <tr>
                                        <td>Delivery within days</td>
                                        <td><input type="number" name="txtdelivery" min='0' <?php if(isset($_GET['txtdelivery']) && $_GET['txtdelivery'] != '') { echo 'value='.sanitize_text_field( $_GET['txtdelivery'] ); } ?> required=""></td>
                                        <td><strong>Note : If you add zero so Delivery Day count is same day</strong><td>
                                    </tr>
                                    <tr>
                                        <td>Cash on Delivery</td>
                        ...
                        <table class="wczp_table">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <label class="wczp_pro_link">Only available in pro version <a href="https://oceanwebguru.com/shop/check-pincode-zipcode-for-shipping-woocommerce-pro/" target="_blank">link</a></label>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr class="wczp_nosrvtxt">
                                <td>Pincode Empty error message</td>
                                <td>
                                    <input type="text" name="wczp_pincode_empty_error_message" value="<?php echo get_option('wczp_pincode_empty_error_message', 'Pincode field should not be empty!'); ?>">
                                </td>
                            </tr>
                            <tr class="wczp_nosrvtxt">
                                <td>Check Availability At Valid City/State Message</td>
                                <td>
                                    <input type="text" name="wczp_availability_citystate" value="YES, We Deliver to {city_name}, {state_name}" disabled>
                                    <label class="wczp_pro_link">Only available in pro version <a href="https://oceanwebguru.com/shop/check-pincode-zipcode-for-shipping-woocommerce-pro/" target="_blank">link</a></label>
